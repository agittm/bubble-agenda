...
public class BubbleItemUI : MonoBehaviour
{
    ...
    {
        EazySoundManager.PlaySound(data.Stereotype.AppearClip);
    ...
    {
        isRunning = false;
        EazySoundManager.PlaySound(data.Stereotype.TimeoutClip);
        animator.SetTrigger("Timeout");
    ...
    {
        EazySoundManager.PlaySound(data.Stereotype.ClickedClip);
